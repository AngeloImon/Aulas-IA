...
#### - Pré-processamento e padronização usando StandardScaler (scikit-learn).
#### - Separação em conjunto de treino e teste com train_test_split.
#### - Treinamento de um classificador K-Nearest Neighbors (KNN) utilizando scikit-learn.
#### - Avaliação de desempenho com métricas de acurácia e matriz de confusão.
